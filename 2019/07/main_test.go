...
func TestPartOne(t *testing.T) {
	...
	for _, test := range tests {
		assert.Equal(t, test.expected, RunWithPhases(test.instructions, test.phases, false))
		assert.Equal(t, test.expected, PartOne(test.instructions))
	}
}
...
func TestPartTwo(t *testing.T) {
	...
	for _, test := range tests {
		assert.Equal(t, test.expected, RunWithPhases(test.instructions, test.phases, true))
		assert.Equal(t, test.expected, PartTwo(test.instructions))
	}
}
